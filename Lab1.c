...
// Runs on TM4C123
// Uses ST7735.c LCD.
// Sung Park and Wallace Tran
// August 28, 2015
// Possible main program to test the lab
// #16520
// Dylan Zika
// August 28, 2015
// Hardware Configuration (which 6812 pin is connected to what external hardware)
...
int main(void){uint32_t i;
  ...
  while(1){
		...
		// Prints ST7735_sDecOut3 to the LCD
    ...
    Pause();
		...
		// Prints ST7735_uBinOut8 to the LCD
    ST7735_FillScreen(0);  // set screen to black
    ST7735_SetCursor(0,0);
